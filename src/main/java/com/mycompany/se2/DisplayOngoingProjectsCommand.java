 ...
 * @author 44736
 */
public class DisplayOngoingProjectsCommand implements Command {
    private Department department;

    public DisplayOngoingProjectsCommand(Department department) {
    ...
    public void execute() {
        ...
        for (Project project : department.getOngoingProjects()) {
